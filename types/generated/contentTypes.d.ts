...
export interface ApiExamRegisterExamRegister
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    examRegisterAgreementAccepted: Schema.Attribute.Boolean;
    examRegisterDisclosureRead: Schema.Attribute.Boolean;
    identifyNo: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiExamExam extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    exam_registers: Schema.Attribute.Relation<
      'oneToMany',
      'api::exam-register.exam-register'
    >;
    examStatus: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    registeredCount: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
export interface ApiPreRegisterPreRegister extends Struct.CollectionTypeSchema {
  collectionName: 'pre_registers';
  info: {
    description: '';
    displayName: 'PreRegister';
    pluralName: 'pre-registers';
    singularName: 'pre-register';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::pre-register.pre-register'
    > &
      Schema.Attribute.Private;
    nameSurname: Schema.Attribute.String;
    parentNameSurname: Schema.Attribute.String;
    parentPhone: Schema.Attribute.String;
    phone: Schema.Attribute.String;
    preRegistrationAgreementAccepted: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    preRegistrationDisclosureRead: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    publishedAt: Schema.Attribute.DateTime;
    registerType: Schema.Attribute.String;
...
export interface ApiStudentStudent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    learningStyle: Schema.Attribute.Enumeration<
    ...
    parentPhone: Schema.Attribute.String;
    parentSurname: Schema.Attribute.String;
    performanceLevel: Schema.Attribute.String;
    preferredTime: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    school: Schema.Attribute.String;
    spetialNeeds: Schema.Attribute.Boolean;
    system_user: Schema.Attribute.Relation<
      'oneToOne',
...
export interface ApiSystemUserSystemUser extends Struct.CollectionTypeSchema {
  collectionName: 'system_users';
  info: {
    description: '';
    displayName: 'SystemUser';
    pluralName: 'system-users';
    singularName: 'system-user';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiTeacherTeacher extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    experienceYear: Schema.Attribute.String;
